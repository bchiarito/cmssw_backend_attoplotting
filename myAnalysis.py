...
class MyAnalysis(Module):
    ...
    def beginJob(self, histFile=None, histDirName=None):
        ...
        self.twoprong_mass = ROOT.TH1F('twoprong_mass', 'twoprong_mass', 150, 0, 15)
        self.addObject(self.twoprong_mass)
        self.twoprong_masspi0 = ROOT.TH1F('twoprong_masspi0', 'twoprong_masspi0', 150, 0, 15)
        self.addObject(self.twoprong_masspi0)
        self.twoprong_masseta = ROOT.TH1F('twoprong_masseta', 'twoprong_masseta', 150, 0, 15)
