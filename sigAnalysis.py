...
class SigAnalysis(Module):
    ...
    def beginJob(self, histFile=None, histDirName=None):
        ...
        # Photon Scalefactor Hists
        self.photon_scaleup_sigmaup = ROOT.TH1F('photon_scaleup_sigmaup', '; Photon p_T', 150, 0, 1500)
        self.photon_scaledown_sigmadown = ROOT.TH1F('photon_scaledown_sigmadown', '; Photon p_T', 150, 0, 1500)
        self.photon_unscaled = ROOT.TH1F('photon_unscaled', '; Photon p_T', 150, 0, 1500)
        self.addObject(self.photon_scaleup_sigmaup)
        self.addObject(self.photon_scaledown_sigmadown)
        self.addObject(self.photon_unscaled)
    ...
    def analyze(self, event):
        ...
        for photon in photons:
            if photon.isScEtaEB and photon.hadTowOverEm < 0.04596: # photon cuts (include pt > 220 for non-scalefactor)
        ...
        self.photon_scaleup_sigmaup.Fill(scaleup_pt, weight)
        self.photon_scaledown_sigmadown.Fill(scaledown_pt, weight)
        self.photon_unscaled.Fill(sel_photon.pt, weight)
